...
- [ ] E16. The AI-on-AI security loop: how an autonomous Red Agent (Wiz) discovered and exploited a CI/CD script-injection vulnerability introduced by GitHub Copilot Autofix in five days with no human in the loop — what the attack surface of AI-generated code looks like in practice, why AI code review missed the regression while the original human-written safe pattern did not, what the "defender's window" framing means for how security teams should structure agentic security tooling, and what compressing the discovery timeline from months to days implies for credential lifetimes and patch deployment velocity (2026-08-18)
